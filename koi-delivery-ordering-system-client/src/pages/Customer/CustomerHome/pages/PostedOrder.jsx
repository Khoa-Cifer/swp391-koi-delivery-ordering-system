import { Box, Menu, MenuItem, Paper, styled, Table, TableBody, TableCell, TableContainer, TableHead, TableRow, Typography } from "@mui/material";
                        ...
                        {expandedOrderId === order.id && (
                            <TableContainer component={Paper} sx={{ mt: 2 }}>
                                <Table aria-label="order-details">
                                    ...
                                    <TableBody>
                                        {order.fishes && order.fishes.map && order.fishes.map((fish, index) => (
