        ...
        {(currentOrder.orderStatus === 0 || currentOrder.orderStatus === 1) && (
          ...
          >
            {currentOrder.orderStatus === 0 ? (
              <Button onClick={() => handleConclusion(currentOrder)}>
                Make your payment
              </Button>
            ) : (
              <Button disabled>Make your payment</Button>
            )}
            <Button onClick={() => handleOpenEditPage(currentOrder)}>
              Edit
            </Button>
            <Button onClick={() => handleDeleteOrder(currentOrder.id)}>
              Delete
            </Button>
          </Box>
        )}
          ...
          <OrderCard>
            ...
            <div className="form-group">
              <OrderInfoField
                fullWidth
                type=""
                value={formatPhoneNumber(currentOrder.receiverPhoneNumber)}
            ...
            <div className="form-group">
              <OrderInfoField
                fullWidth
                type=""
                value={new Date(currentOrder.createdDate).toLocaleString(
                  "en-US",
                  {
                    year: "numeric",
                    month: "2-digit",
            ...
            {currentOrder.finishDate ? (
              <div className="form-group">
                <OrderInfoField
                  fullWidth
                  type=""
                  value={new Date(currentOrder.finishDate).toLocaleString(
                    "en-US",
                    {
                      year: "numeric",
                      month: "2-digit",
              ...
              <div className="form-group">
                <OrderInfoField
                  ...
                  type=""
                  value={new Date(
                    currentOrder.expectedFinishDate
                  ).toLocaleDateString()}
              ...
              {currentOrder.fishes &&
                ...
                currentOrder.fishes.map((fish) => (
                  <TableRow key={fish.id}>
                    ...
                    {fish.status === 0 && <TableCell>Unknown</TableCell>}
                    ...
                    <TableCell>
                      ...
                      >
                        {(currentOrder.orderStatus === 0 ||
                          ...
                          <MenuItem
                            onClick={() =>
                              handleDeleteFish(fish.id, currentOrder)
                            }
                          >
                            Delete Fish
                          </MenuItem>
